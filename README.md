...
> ***NOTE**: This project is built, but there's still work to do. Check out the [journal](JOURNAL.md) for progress updates! Right now I'm:* `bashing together some code`
